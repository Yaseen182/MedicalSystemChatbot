 ...
 * Run with: node src/utils/seedMedical.js
 */

require('dotenv').config();
const { addDocuments } = require('../rag/ragService');
...
const seed = async () => {
  ...
  try {
    ...
    logger.info(`✓ Seeded ${docs.length} medical documents into ChromaDB`);
  } catch (err) {
